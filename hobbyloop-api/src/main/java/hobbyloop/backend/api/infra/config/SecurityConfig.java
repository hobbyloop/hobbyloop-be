...
import hobbyloop.backend.api.infra.global.login.filter.CustomJsonUsernamePasswordAuthenticationFilter;
import hobbyloop.backend.api.infra.global.login.handler.LoginFailureHandler;
import hobbyloop.backend.api.infra.global.login.handler.LoginSuccessHandler;
import hobbyloop.backend.api.infra.global.login.service.LoginService;
...
public class SecurityConfig {
    ...
    public LoginSuccessHandler loginSuccessHandler() {
        return new LoginSuccessHandler(jwtService, userApplicationService);
    }
