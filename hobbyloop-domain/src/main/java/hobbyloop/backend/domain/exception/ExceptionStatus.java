...
public enum ExceptionStatus {
    ...
    NOT_SUPPORTED_SOCIAL_TYPE(HttpStatus.BAD_REQUEST, "Global-004" ,"요청에 대한 SOCIAL Enum Type 을 찾을 수 없음"),
    CANNOT_EXTRACT_SOCIAL_NAME_IN_URL(HttpStatus.BAD_REQUEST, "Global-005" ,"요청 주소에서 socialName 을 추출할 수 없음"),
